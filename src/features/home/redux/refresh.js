...
export function dismissRefreshError() {
  return {
...
export function reducer(state, action) {
  switch (action.type) {
    ...
    case HOME_REFRESH_DISMISS_ERROR:
