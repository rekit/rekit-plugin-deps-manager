  ...
  return (dispatch) => { // optionally you can have getState as the second argument
    ...
    const promise = new Promise((resolve, reject) => {
      ...
      doRequest.then(
        (res) => {
          dispatch({
            type: HOME_FETCH_DEPS_REMOTE_SUCCESS,
            data: res,
          });
          resolve(res);
        },
        ...
        (err) => {
          dispatch({
            type: HOME_FETCH_DEPS_REMOTE_FAILURE,
            data: { error: err },
          });
          reject(err);
        },
...
export function reducer(state, action) {
  switch (action.type) {
    case HOME_FETCH_DEPS_REMOTE_BEGIN:
    ...
    case HOME_FETCH_DEPS_REMOTE_SUCCESS:
    ...
    case HOME_FETCH_DEPS_REMOTE_FAILURE:
    ...
    case HOME_FETCH_DEPS_REMOTE_DISMISS_ERROR:
