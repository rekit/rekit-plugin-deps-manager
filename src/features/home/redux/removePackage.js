  ...
  return dispatch => {
    ...
    const promise = new Promise((resolve, reject) => {
      ...
      doRequest.then(
        res => {
          dispatch({
            type: HOME_REMOVE_PACKAGE_SUCCESS,
            data: res,
          });
          resolve(res);
        },
        ...
        err => {
          dispatch({
            type: HOME_REMOVE_PACKAGE_FAILURE,
            data: { error: err },
          });
          reject(err);
        },
...
export function reducer(state, action) {
  switch (action.type) {
    case HOME_REMOVE_PACKAGE_BEGIN:
    ...
    case HOME_REMOVE_PACKAGE_SUCCESS:
    ...
    case HOME_REMOVE_PACKAGE_FAILURE:
    ...
    case HOME_REMOVE_PACKAGE_DISMISS_ERROR:
